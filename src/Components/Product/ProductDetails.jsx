...
const ProductDetails = ()=> {
    ...
    useEffect(() => {
        fetch(`https://brand-shop-server-side-31efspzvl-ayons-projects.vercel.app/product/${id}`)
            .then(res => res.json())
    ...
    const addtocart = (Cart) => {
        fetch('https://brand-shop-server-side-31efspzvl-ayons-projects.vercel.app/Mycarts', 
           {
            method : 'POST',
            headers : {
